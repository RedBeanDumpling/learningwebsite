...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form">
					...
					<form action="examRecordList.do" method="post" name="regForm">
					...
					<tbody class="news_content">
					   <c:forEach items="${pageInfo.list}" var="exam">
						<tr>
							...
							<td>${exam.score}分</td>
							<td>
							<a class="layui-btn  layui-btn-mini" href="examResult.do?id=${exam.id}">回顾</a>
							<a class="layui-btn  layui-btn-mini" href="examDel.do?id=${exam.id}">删除</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
        ...
        layui.use(['laypage', 'layer'], function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj,first){
                    ...
                    if (!first) {
                        location.replace("examRecordList.do?pageNum="+currentpage+"&pageSize="+pageSize)
                    }
