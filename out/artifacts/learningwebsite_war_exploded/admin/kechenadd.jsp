...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/kechenAdd.do" onsubmit="return supplieradd()">
				
				<input type="hidden" name="delstatus" value="0"/>
				<div class="layui-form-item">
					<label class="layui-form-label">课程名称</label>
					<div class="layui-input-block">  
					  	<input type="text" name="kcname" id="kcname" required oninvalid="setCustomValidity('课程名称不能为空')" oninput="setCustomValidity('');"  style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="课程名称不能为空" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					<input name='filename' type='text' class="layui-input" required  style="width: 300px;" id='url'  size='50'  />&nbsp;<input type='button' value='上传'  class="layui-input" onClick="up('url')" style="width: 60px;height: 37px;"/>
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea id="editor_id" name="content" style="width: 600;height: 280px;" placeholder="课程介绍"  class="layui-textarea"  ></textarea>
					</div>
				</div>
