...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="updateform" method="post" action="<%=path %>/admin/memberEdit.do">
			 	<input type="hidden" name="id" value="${member.id}"/>
			 	
			 	<div class="layui-form-item">
					<label class="layui-form-label">用户名</label>
					<div class="layui-input-block">  
					  	<input type="text" name="uname" id="uname" value="${member.uname }" readonly="readonly"  style="width: 300px;"   autocomplete="off"  class="layui-input"  >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="tname" value="${member.tname}" style="width: 300px;" required autocomplete="off"  class="layui-input"  placeholder="请输入真实姓名">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="date" name="brithtime" id="brithtime"  value="${member.brithtime}" required oninvalid="setCustomValidity('出生年月不能为空')" oninput="setCustomValidity('');"   style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="tel" id="tel" value="${member.tel }" required oninvalid="setCustomValidity('请输入11位数字或非法输入')" oninput="setCustomValidity('');" pattern="[1][3,4,5,7,8][0-9]{9}"  style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<textarea rows="" cols="" name="aihao" style="width: 540px;height: 100px;">${member.aihao}</textarea>
					</div>
				</div>
