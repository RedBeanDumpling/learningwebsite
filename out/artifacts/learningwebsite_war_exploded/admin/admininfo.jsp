...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="updateform" method="post" action="update.do">
			<input type="hidden"  name="id"  value="${user.id }"/>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="password" name="userpassword" id="userpassword" required style="width: 300px;"  autocomplete="off"  class="layui-input"  placeholder="密码">
					</div>
				</div>
