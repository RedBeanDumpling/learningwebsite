...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline">
		    <div class="layui-input-inline">
		      <form action="<%=path %>/admin/categoryList.do" method="post" id="searchform" name="searchform">
		    	<input value="${key}" placeholder="请输入分类名称" name="key" class="layui-input search_input" type="text">
		...
		<div class="layui-inline">
		<a class="layui-btn layui-btn-normal" href="categoryadd.jsp">添加分类</a>
		</div>
	</blockquote>
					   ...
					   <c:forEach items="${pageInfo.list}" var="category">
						<tr>
							...
							<td>
							   ...
							   <a class="layui-btn layui-btn-danger layui-btn-mini" href="categoryDel.do?id=${category.id}" ><i class="layui-icon"></i> 删除</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
            ...
            layui.use(['laypage', 'layer'], function(){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj,first){
                        ...
                        if (!first) {
                            location.replace("categoryList.do?pageNum="+currentpage+"&pageSize="+pageSize+"&key="+key)
                        }
