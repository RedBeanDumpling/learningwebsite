...
<!-- AddThis Smart Layers END -->
	...
	<div class="main-banner" >
         ...
         <div class="col-md-4 banner-right" style="border:1px solid #EEEEEE;width: 24.33333333%;padding:0px;border-radius:10px 10px;">
			<h5 style="background: #003B64;margin: 0px;width: 100%;border:0px solid black;padding-left:8px;border-radius:10px 10px 0px 0px;height: 40px;line-height: 40px;color:white;">最新公告</h5>
