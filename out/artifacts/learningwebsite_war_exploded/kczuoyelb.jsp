...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form">
				    ...
				    <button style="background:#003B64;color:white;width: 80px;height: 35px;border:0px; " onclick="add('skipkechenlr.do?kcid=${kcid}&flag=作业&biaoji=kechenlradd')">上传作业</button>
					...
					<tbody class="news_content">
					   <c:forEach items="${pageInfo.list}" var="kczuoye">
						<tr>
							<td>${kczuoye.title}</td>
							<td>${kczuoye.savetime}</td>
							<td>${kczuoye.shstatus}</td>
							<td>
							   <a class="layui-btn layui-btn-mini" href="skipkechenlr.do?id=${kczuoye.id}&kcid=${kcid}&flag=作业&biaoji=kechenlredit">编辑</a>
							   <a class="layui-btn layui-btn-danger layui-btn-mini" href="kczuoyeSc.do?id=${kczuoye.id}">删除</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
            ...
            layui.use(['laypage', 'layer'], function(){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj,first){
                        ...
                        if (!first) {
                            location.replace("kczuoyeLb.do?pageNum="+currentpage+"&pageSize="+pageSize+"&kcid="+kcid)
                        }
