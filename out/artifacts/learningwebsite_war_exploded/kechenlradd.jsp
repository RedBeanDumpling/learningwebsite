...
<!-- AddThis Smart Layers END -->
	...
	<ol class="breadcrumb">
			  ...
			  <li class="active">添加${flag }</li>
			</ol>
	<!----->
	<div class="contact" style="border:0px solid red;">
	
	<div style="font-size:24px;text-align: center;">添加${flag }</div>
	<div class="contact-form" style="border:0px solid red;">
					...
					<form action="kechenlrAdd.do" method="post" name="regForm">
					<input type="hidden" name="delstatus" value="0">
					<input type="hidden" name="flag" value="${flag }">
					<input type="hidden" name="kcid" value="${kcid }">
					
						<p class="your-para">标题:</p>
						<input type="text"  name="title" required oninvalid="setCustomValidity('标题不能为空')" oninput="setCustomValidity('');">
						...
						<input type="date"  id="savetime" name="savetime" value="<%=Info.getDateStr().substring(0,10) %>" style="height: 45px;"  required oninvalid="setCustomValidity('完成时间不能为空')" oninput="setCustomValidity('');">
						</c:if>
