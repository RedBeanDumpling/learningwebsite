...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form" style="border:0px solid red;">
					...
					<form action="kechenSub.do" method="post" name="regForm">
						<p class="your-para">课程名称:</p>
						<input type="text"  name="kcname" required oninvalid="setCustomValidity('课程名称不能为空')" oninput="setCustomValidity('');">
					
						<p class="your-para">图片:</p>
						<input name='filename' type='text' readonly="readonly" class="layui-input" lay-verify="required"   id='url' required size='50' value='' />&nbsp;<input type='button' value='上传'  class="layui-input" onClick="up('url')" style="width: 60px;height: 37px;"/>
