...
<style type="text/css">
.contact-grid input[type="email"],.contact-grid select,.contact-grid input[type="password"] {
  width: 100%;
  padding:0.8em;
  margin: 0 0 0.8em 0;
...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form">
					...
					<input type="hidden" name="delstatus" value="0">
						...
						<input type="password"  name="upass"  required oninvalid="setCustomValidity('密码不能为空')" oninput="setCustomValidity('');">
						...
						<input type="email"  name="email" required oninvalid="setCustomValidity('输入错误')" oninput="setCustomValidity('');">
						
						<p class="your-para"></p>
						<p class="your-para">请选择注册类型:</p>
						<select name="utype" required oninvalid="setCustomValidity('请选择注册类型')" oninput="setCustomValidity('');">
