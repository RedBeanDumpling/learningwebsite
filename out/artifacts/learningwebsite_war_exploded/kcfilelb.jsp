...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form">
				    ...
				    <button style="background:#003B64;color:white;width: 80px;height: 35px;border:0px; " onclick="add('skipkechenlr.do?kcid=${kcid}&flag=课件&biaoji=kechenlradd')">上传课件</button>
					...
					<tbody class="news_content">
					   <c:forEach items="${pageInfo.list}" var="kcfile">
						<tr>
							<td>${kcfile.title}</td>
							<td>${kcfile.savetime}</td>
							<td>${kcfile.shstatus}</td>
							<td>
							   <a class="layui-btn layui-btn-mini" href="skipkechenlr.do?id=${kcfile.id}&kcid=${kcid}&flag=课件&biaoji=kechenlredit">编辑</a>
							   <a class="layui-btn layui-btn-danger layui-btn-mini" href="kcfileSc.do?id=${kcfile.id}">删除</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
            ...
            layui.use(['laypage', 'layer'], function(){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj,first){
                        ...
                        if (!first) {
                            location.replace("kcfileLb.do?pageNum="+currentpage+"&pageSize="+pageSize+"&kcid="+kcid)
                        }
