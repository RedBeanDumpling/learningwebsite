...
public class CategoryController{
    ...
    public String categoryList(@RequestParam(defaultValue = "1",value = "pageNum") Integer pageNum, @RequestParam(defaultValue = "10",value = "pageSize") Integer pageSize, HttpServletRequest request) {
        ...
        PageInfo<Category> pageInfo = new PageInfo<Category>(objectlist);
