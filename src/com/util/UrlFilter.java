	...
	public void doFilter(ServletRequest servletRequest,
		...
		if (!this.isContains(req.getRequestURI(), logonList)) {
			...
			if(requestURI.contains("admin")&&admin==null){
					res.sendRedirect("/learningwebsite/admin/login.jsp");
					return;
			}
			if(!requestURI.contains("admin")&&member==null){
				//res.sendRedirect("qtindex.do");
				if(requestURI.contains("pinlunAdd.do")||requestURI.contains("downfile.do")||requestURI.contains("baomingAdd.do")||requestURI.contains("messageAdd.do")
){
