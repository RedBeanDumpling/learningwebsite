	...
	public static String getDateStr(){
	 ...
	 /**
		...
		public static String getDay(String date,int day) {
	       ...
	       // System.out.println("sesuu==="+sesuu);
	        
			return sesuu.substring(0,10)+m;
		}
	    ...
	    public static void writeExcel(String fileName,String[] pros,java.util.List<List> list,HttpServletRequest request, HttpServletResponse response){    
	        ...
	        try {
				response.sendRedirect("/learningwebsite/upload?filename="+fileName.substring(fileName.lastIndexOf("/")+1));
			} catch (IOException e) {
				e.printStackTrace();
			}
