					...
					<tbody class="news_content">
					   <c:forEach items="${pageInfo.list}" var="zuoye">
						<tr>
							...
							<td>${zuoye.teacher.tname}</td>
							<td><a href="upload?filename=${zuoye.filename}">${zuoye.filename}</a></td>
							<td>${zuoye.savetime}</td>
							<td>
							<a class="layui-btn layui-btn-danger layui-btn-mini" href="zuoyeSc.do?id=${zuoye.id}">删除</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
        ...
        layui.use(['laypage', 'layer'], function(){
            ...
            laypage.render({
                ...
                ,jump: function(obj,first){
                    ...
                    if (!first) {
                        location.replace("zuoyeLb.do?pageNum="+currentpage+"&pageSize="+pageSize)
                    }
