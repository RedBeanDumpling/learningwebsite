...
<!-- AddThis Smart Layers END -->
	    ...
	    <div class="layui-col-md12">
	      <div class="layui-card">
	        <div class="layui-card-body">
	        	...
	        	<font style="font-weight: bold;color: red">得分：<u>${exam.score }分</u></font>
			</div>
	      </div>
	    </div>
	  </div>
	...
	<div style="padding: 20px; background-color: #F2F2F2;">
	  <div class="layui-row layui-col-space15">
	    <div class="layui-col-md12">
	      <div class="layui-card">
	        <div class="layui-card-header"><b>${detail.qno}. ${detail.question.title }</b> &nbsp;&nbsp;(${detail.question.score}分)&nbsp;&nbsp; 
	        <font color="blue"><b>${detail.question.myanswer }</b></font>&nbsp;&nbsp; 
	        <font color="red"><b>标答：${detail.question.answer }</b></font>&nbsp;&nbsp; 
	        <i class="layui-icon">${detail.question.myanswer eq detail.question.answer?"&#xe605;":"&#x1006;"}</i>   </div>
	        <div class="layui-card-body">
	        <table class="layui-table" lay-size="sm" lay-skin="nob">
			  ...
			  <c:forEach items="${detail.question.answerslist }" var="answers">
			    <tr>
			      ...
			      <input type="radio" id="an${answers.questionid }" name="an${answers.questionid }" value="${answers.option }"  ${fn:indexOf(detail.question.myanswer,answers.option)!=-1?"checked":""}> 
	      ...
	      <div class="layui-card">
	        ...
	        <table class="layui-table" lay-size="sm" lay-skin="nob">
			  ...
			  <c:forEach items="${detail.question.answerslist }" var="answers">
			    <tr>
			      <td style="width: 30px">
			      	<input type="checkbox" id="an${answers.questionid }" name="an${answers.questionid }" value="${answers.option }"  ${fn:indexOf(detail.question.myanswer,answers.option)!=-1?"checked":""}> 
			      </td>
			      <td style="width: 30px">${answers.option }.</td>
			      <td>${answers.content }</td>
			    </tr>
