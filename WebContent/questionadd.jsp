...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form" style="border:0px solid red;">
					...
					<form action="questionsAdd.do" method="post" name="regForm" onsubmit="return sub()">
						...
						<select name="kcid" id="kcid" style="width: 300px;"  required  autocomplete="off"  class="layui-input">
						  	...
						  	<c:forEach items="${kclist}" var="kc">
						  	  <option value="${kc.id}">${kc.kcname}</option>
						  	</c:forEach>
					  	</select>
						...
						<textarea type="text"  name="title" required oninvalid="setCustomValidity('试题题目不能为空')" oninput="setCustomValidity('');"></textarea>
					
						<p class="your-para">选项:</p>
						<input type="checkbox" id="options" name="options" value="A">
						A.<input type="text"  name="aoption" style="width: 400px" required oninvalid="setCustomValidity('选项A不能为空')" oninput="setCustomValidity('');"><br/>
						<input type="checkbox" id="options" name="options" value="B">
						B.<input type="text"  name="boption" style="width: 400px" required oninvalid="setCustomValidity('选项B不能为空')" oninput="setCustomValidity('');"><br/>
						<input type="checkbox" id="options" name="options" value="C">
						C.<input type="text"  name="coption" style="width: 400px" required oninvalid="setCustomValidity('选项C不能为空')" oninput="setCustomValidity('');"><br/>
						<input type="checkbox" id="options" name="options" value="D">
						D.<input type="text"  name="doption" style="width: 400px" required oninvalid="setCustomValidity('选项D不能为空')" oninput="setCustomValidity('');">
						
						<p class="your-para">分值:</p>
						<input type="number" step="1" min="1" name="score" class="layui-input" required oninvalid="setCustomValidity('分值不能为空')" oninput="setCustomValidity('');">
