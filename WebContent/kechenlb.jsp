...
<!-- AddThis Smart Layers END -->
	...
	<div class="contact-form">
					...
					<tbody class="news_content">
					   <c:forEach items="${pageInfo.list}" var="kechen">
						<tr>
							...
							<td>
							<a class="layui-btn  layui-btn-mini" href="kcvideoLb.do?kcid=${kechen.id}">课程视频</a>
							<a class="layui-btn  layui-btn-mini" href="kcfileLb.do?kcid=${kechen.id}">课件信息</a>
							<a class="layui-btn  layui-btn-mini" href="kczuoyeLb.do?kcid=${kechen.id}">作业信息</a>
							<a class="layui-btn  layui-btn-mini" href="toCreatePaper.do?kcid=${kechen.id}">试卷组题</a>
							</td>
							<td>
							<a class="layui-btn  layui-btn-mini" href="toKechenEdit.do?id=${kechen.id}">编辑</a>
							<a class="layui-btn  layui-btn-mini" href="kechenDelete.do?id=${kechen.id}">删除</a>
							</td>
						</tr>
						</c:forEach>
						<tr>
                    ...
                    <td>
                    	<a class="layui-btn  layui-btn-mini" href="toKechenSub.do?flag=kechenadd">添加课程</a>
                    </td>
                  </tr>
					</tbody>
					</table>
            ...
            layui.use(['laypage', 'layer'], function(){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj,first){
                        ...
                        if (!first) {
                            location.replace("kechenLb.do?pageNum="+currentpage+"&pageSize="+pageSize)
                        }
