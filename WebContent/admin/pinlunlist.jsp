	...
	<div class="larry-personal">
		...
		<div class="layui-inline">
		    <div class="layui-input-inline">
		      <form action="pinlunList.do" method="post" id="searchform" name="searchform">
		    	<input value="${key}" placeholder="请输入评论人" name="key" class="layui-input search_input" type="text">
            ...
            layui.use(['laypage', 'layer'], function(){
                ...
                laypage.render({
                    ...
                    ,jump: function(obj,first){
                        ...
                        if (!first) {
                            location.replace("pinlunList.do?pageNum="+currentpage+"&pageSize="+pageSize+"&key="+key)
                        }
