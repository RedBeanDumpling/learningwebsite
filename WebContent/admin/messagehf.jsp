...
<script charset="utf-8" src="/choosesetssm/kindeditor/kindeditor-all.js"></script>
<script charset="utf-8" src="/choosesetssm/kindeditor/lang/zh-CN.js"></script>
<script>
...
uploadJson : '/choosesetssm/kindeditor/jsp/upload_json.jsp',
fileManagerJson : '/choosesetssm/kindeditor/jsp/file_manager_json.jsp',
...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/messageEdit.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="hfcontent" id="hfcontent"  required oninvalid="setCustomValidity('回复内容不能为空')" oninput="setCustomValidity('');"  style="width: 100%;"  autocomplete="off"  class="layui-input" placeholder="回复内容不能为空" >
					</div>
				</div>
...
<script type="text/javascript">
	...
	function up(tt)
	{
			    layer.open({
			      ...
			      area: ['450px', '200px'],
			      content: '/choosesetssm/upload.jsp?Result='+tt
			    });
	}	
