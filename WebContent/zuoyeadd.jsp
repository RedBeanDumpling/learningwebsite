...
<!-- AddThis Smart Layers END -->
	...
	<ol class="breadcrumb">
			  ...
			  <li class="active">学生提交作业</li>
			</ol>
	<!----->
	<div class="contact" style="border:0px solid red;">
	
	<div style="font-size:24px;text-align: center;">学生提交作业</div>
	<div class="contact-form" style="border:0px solid red;">
					...
					<form action="zuoyeAdd.do" method="post" name="regForm">
					<input type="hidden" name="zyid" value="${zyid}">
